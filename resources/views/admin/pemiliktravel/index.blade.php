                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            <div>
                                <h4 class="mb-3">Data Pemilik Travel</h4>
                                <p class="mb-0">Data Pemilik Travel akan menampilkan detail Pemilik yang telah mendaftar
                                </p>
                            </div>
                            ...
                            <table class="data-tables table mb-0 tbl-server-info">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->logo)
                                            <img style="max-width:80px; max-height:80px" src="logo/{{$item->logo}}" />
                                            @endif
                                        </td>
                                        <td>{{ $item->alamat}}</td>
                                        <td>{{ $item->notelp}}</td>
                                        ...
                                        {{-- <td>
                                            @if ($item->foto)
                                            <img style="max-width:80px; max-height:80px" src="foto/{{$item->foto}}" />
                                            @endif
                                        </td> --}}
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center list-action">
                                                {{-- <a class="badge bg-primary mr-2" data-toggle="tooltip"
                                                    ...
                                                    href="/detail/{{ $item->id}}"><i
                                                        class="ri-information-line mr-0"></i></a> --}}
                                                <a href="{{ route('dataa', $item->id) }}" class="badge bg-primary mr-2"
                                                    data-toggle="tooltip" data-placement="top" title=""
                                                    data-original-title="Detail"><i
                                                        class="ri-information-line mr-0"></i></a>
                                                <a class="badge bg-warning mr-2 border-0 delete"
                                                    data-id="{{ $item->id }}" data-nama="{{ $item->travel }}"
                                                    data-toggle="tooltip" data-placement="top" data-bs-target="modal"
                                                    title="" data-original-title="Hapus" href="#"><i
                                                        class="ri-delete-bin-line mr-0"></i></a>
                                                {{-- <form class="badge"
                                                    onsubmit="return confirm('Yakin ingin menghapus data?')"
                                                    action="{{ url('/deletepemilik/'.$item->id)}}"><button
                                                        class="badge bg-warning mr-2" data-toggle="tooltip"
                                                        data-placement="top" title="" data-original-title="Hapus"><i
                                                            class="ri-delete-bin-line mr-0"></i></button></form> --}}
                                            </div>
                                        </td>
                                    </tr>
