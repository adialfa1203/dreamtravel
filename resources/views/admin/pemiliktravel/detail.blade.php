...
<!-- Mirrored from templates.iqonic.design/lite/posdash/html/backend/page-list-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Feb 2023 02:59:20 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">Detail akan menampilkan detail Kendaraan yang dimiliki travel</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                src="foto_kendaraan/{{$data->foto_kendaraan}}"/>
                            @endif 
                            </td>
                            {{-- <td>
                                @if ($item->foto)
                            ...
                            {{-- <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"
                                        href="{{ url('/delete/'.$item->id)}}"><i class="ri-delete-bin-line mr-0"></i></a>
                                </div>
                            </td> --}}
                        </tr>
