                              ...
                              <div class="col-lg-7 align-self-center">
                                 <div class="p-3">
                                    ...
                                    <form>
                                          ...
                                          <div class="col-lg-6">
                                             <div class="custom-control custom-checkbox mb-3">
                                                ...
                                                <label class="custom-control-label control-label-1"
                                                   for="customCheck1">Ingat saya</label>
                                             </div>
                                          </div>
                                          <div class="col-lg-6">
                                             <a href="auth-recoverpw.html" class="text-primary float-right">Lupa
                                                password ?</a>
                                          </div>
                                       </div>
                                       <a href="">
                                       ...
                                       <p class="mt-3">
                                          Belum punya Akun ? <a href="{{url('register')}}" class="text-primary">Daftar
                                             Sekarang !</a>
                                       </p>
                                    </form>
                                 </div>
