                                          ...
                                          <div class="card-body p-0 ">
                                              <div class="cust-title p-3">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                      ...
                                                      <a class="badge badge-primary badge-card" href="{{url('pesan')}}">3</a>
                                                  </div>
                                              </div>
                                              <div class="px-3 pt-0 pb-0 sub-card">
                                                <a href="{{url('pesan')}}" class="iq-sub-card">
                                  ...
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 ">
                                              ...
                                              <div class="px-3 pt-0 pb-0 sub-card">
                                                  <a href="{{url('notif')}}" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="../assets/images/user/01.jpg" alt="01">
                                              ...
                                              <a class="right-ic btn btn-primary btn-block position-relative p-2" href="{{url('semuanotif')}}"
                                                  role="button">
                                                  Tampilkan Semua
                                              </a>
                                          </div>
                                          ...
                                          <div class="card-body p-0 text-center">
                                              ...
                                              <div class="p-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center mt-3">
                                                    ...
                                                    <a href="{{url ('login')}}" class="btn border">Keluar</a>
                                                </div>
                                            </div>
                                          </div>
                                      </div>
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="">
                                        <img src="../assets/images/logo/pengguna.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="">
                                        <img src="../assets/images/logo/pesanan.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="">
                                        <img src="../assets/images/logo/travel.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                ...
                <div class="card card-block card-stretch card-height">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Travel Teratas</h4>
                        </div>
                        ...
                        <ul class="list-unstyled row top-product mb-0">
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="">
                                            <img src="../assets/images/logo/3.png" class="style-img img-fluid m-auto " alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Jordy Travel</h5>
                                            <p class="mb-0">789 Pelaggan</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="">
                                            <img src="../assets/images/logo/2.png" class="style-img img-fluid m-auto" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Rudi Travel</h5>
                                            <p class="mb-0">657 Pelanggan</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="">
                                            <img src="../assets/images/logo/1.png" class="style-img img-fluid m-auto " alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Slamet Travel</h5>
                                            <p class="mb-0">489 Pelanggan</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="">
                                            <img src="../assets/images/logo/4.png" class="style-img img-fluid m-auto" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Yanto Travel</h5>
                                            <p class="mb-0">468 Pelanggan</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
...
<!-- Mirrored from templates.iqonic.design/lite/posdash/html/backend/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Feb 2023 02:59:20 GMT -->
</html>