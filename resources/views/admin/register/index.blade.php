                              ...
                              <div class="col-lg-7 align-self-center">
                                 <div class="p-3">
                                    ...
                                    <form>
                                       <div class="row">
                                          <div class="col-lg-6">Nama
                                             <div class="floating-label form-group">
                                                <input class="floating-input form-control" name="nama" type="text"
                                                   placeholder="Nama">
                                             </div>
                                          </div>
                                          <div class="col-lg-6">Alamat
                                             <div class="floating-label form-group">
                                                <input class="floating-input form-control" name="alamat" type="text"
                                                   placeholder="Alamat">
                                             </div>
                                          </div>
                                          <div class="col-lg-6">Tanggal Lahir
                                             <div class="floating-label form-group">
                                                <input class="floating-input form-control" name="tanggal" type="date"
                                                   placeholder="Tanggal Lahir">
                                             </div>
                                          </div>
                                          <div class="col-lg-6">No Telepon
                                             <div class="floating-label form-group">
                                                <input class="floating-input form-control" name="no" type="number"
                                          ...
                                          <div class="col-lg-12">
                                             <div class="custom-control custom-checkbox mb-3">
                                                ...
                                                <label class="custom-control-label" for="customCheck1">Saya setuju
                                                   dengan ketentuan penggunaan</label>
                                             </div>
                                          </div>
                                       </div>
                                       @if ($errors->any())
                                       ...
                                       <p class="mt-3">
                                          Sudah memiliki Akun ?<a href="{{url('login')}}" class="text-primary"> Masuk
                                             !</a>
                                       </p>
                                    </form>
                                 </div>
