                                ...
                                <div class="form-group">
                                    ...
                                    <div class="img-extension mt-3">
                                        ...
                                        <div class="new-user-info">
                                            <form action="/updatee/{{ Auth::user()->id }}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="mobno"
                                                            placeholder="Nomor Telepon" value="{{ Auth::user()->no }}"
                                                            name="no">
                                                    </div>
                                                    {{-- <div class="form-group col-md-6">
                                                    ...
                                                    {{-- <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="city"
                                                                placeholder="Tambahkan Deskripsi" rows="1"></textarea>
                                                        </div>
                                                    </div> --}}
                                                </div>
                                                <hr>
