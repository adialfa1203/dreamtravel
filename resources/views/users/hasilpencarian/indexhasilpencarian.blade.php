      ...
      <div class="col-md-6">
            ...
            <div class="recom-item border faq-title" data-toggle="collapse" data-target="#faqCollapse-1"
              ...
              <div class="recom-item-body"><a href="/detailtravel">
                ...
                <a class="recom-button faq-title" data-toggle="collapse" data-target="#faqCollapse-1"
                  data-aria-expanded="true" data-aria-controls="faqCollapse-1">Detail</a><a
                  href="{{ url('pemesanan') }}" class="cws-button small alt">Pesan Sekarang</a>
                <!-- <div class="action font-2">20%</div> -->
              </div>
              <!-- Recomended Image-->
            </div>
            <div id="faqCollapse-1" class="collapse col-md-12" aria-labelledby="faqHeading-1" data-parent="#accordion">
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="menu-widget with-switch">
                        <ul class="magic-line">
                          <li class="current_item active"><a href="#" data-filter=".waktu"
                              class="filter active">Waktu</a></li>
                          <li><a href="#" data-filter=".kendaraan" class="filter">Kendaraan</a></li>
                          <li><a href="#" data-filter=".harga" class="filter">Harga</a></li>
        ...
        {{-- <div class="card"> --}}
          <div class="col-md-12">
            ...
            <div id="faqCollapse-2" class="collapse col-md-12" aria-labelledby="faqHeading-2" data-parent="#accordion">
              <div class="card-body">
                <div class="element-section mb-80">
                  <div class="row">
                    <div class="col-md-12">
        ...
        {{-- <div class="card"> --}}
          <div class="col-md-12">
            ...
            <div id="faqCollapse-3" class="collapse col-md-12" aria-labelledby="faqHeading-3" data-parent="#accordion">
              <div class="card-body">
                <div class="element-section mb-80">
                  <div class="row">
                    <div class="col-md-12">
      ...
      <div class="col-md-6">
        {{-- <div class="card"> --}}
          <div class="col-md-12">
            ...
            <div id="faqCollapse-4" class="collapse col-md-12" aria-labelledby="faqHeading-4" data-parent="#accordion">
              <div class="card-body">
                <div class="element-section mb-80">
                  <div class="row">
                    <div class="col-md-12">
        ...
        {{-- <div class="card"> --}}
          <div class="col-md-12">
            ...
            <div id="faqCollapse-5" class="collapse col-md-12" aria-labelledby="faqHeading-5" data-parent="#accordion">
              <div class="card-body">
                <div class="element-section mb-80">
                  <div class="row">
                    <div class="col-md-12">
        ...
        {{-- <div class="card"> --}}
          <div class="col-md-12">
            ...
            <div id="faqCollapse-6" class="collapse col-md-12" aria-labelledby="faqHeading-6" data-parent="#accordion">
              <div class="card-body">
                <div class="element-section mb-80">
                  <div class="row">
                    <div class="col-md-12">
