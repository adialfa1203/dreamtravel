...
<section class="small-section cws_prlx_section bg-white-80 pb-0" id="cws_prlx_section_481501519592"><img
  src="pic/parallax-4.jpg" alt="" class="cws_prlx_layer" id="cws_prlx_layer_788353406674"
...
<section class="faq-section" style="background-color: orange;">
...
<div class="row">
    ...
    <div class="faq" id="accordion">
      <div class="card">
        <div class="card-header" id="faqHeading-1">
          <div class="mb-0">
            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-1"
              ...
              <span class="badge">1</span>Bagaimana cara memesan travel?
            </h5>
          </div>
        </div>
        <div id="faqCollapse-1" class="collapse" aria-labelledby="faqHeading-1"
          ...
          <div class="card-body">
            <p>Untuk memesan tiket anda bisa ke menu pesan, lalu cari rute yang anda inginkan dan
              pilih travel mana yang ingin anda pakai
            </p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="faqHeading-2">
          <div class="mb-0">
            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-2"
              ...
              <span class="badge">2</span> Jasa apa yang ditawarkan di website ini?
            </h5>
          </div>
        </div>
        <div id="faqCollapse-2" class="collapse" aria-labelledby="faqHeading-2"
          data-parent="#accordion">
          <div class="card-body">
            <p>Dream travel merupakan website yang melayani jasa perjalanan/travel antar kota</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="faqHeading-3">
          <div class="mb-0">
            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-3"
              ...
              <span class="badge">3</span>Transportasi apa saja yang ada di setiap travel
            </h5>
          </div>
        </div>
        <div id="faqCollapse-3" class="collapse" aria-labelledby="faqHeading-3"
          data-parent="#accordion">
          <div class="card-body">
            <p>Untuk transportasi ada mobil, elf, jeep dsb</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="faqHeading-4">
          <div class="mb-0">
            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-4"
              ...
              <span class="badge">4</span> Bagaimana kami menghubungi travel ketika ingin
              melakukan
              pemesanan?
            </h5>
          </div>
        ...
        <div id="faqCollapse-4" class="collapse" aria-labelledby="faqHeading-4"
          data-parent="#accordion">
          <div class="card-body">
            <p>Untuk pemesanan lebih lanjut anda akan dihubungkan langsung dengan kontak WhatsApp
              travel yang anda pesan</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="faqHeading-5">
          <div class="mb-0">
            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-5"
              ...
              <span class="badge">5</span>Kamu Nanya ?
            </h5>
          </div>
        </div>
  ...
  <div class="col-md-6 offset-md-3 ">
    <img src="pic/png-transparent-confused-man-removebg-preview.png" alt=""
      style="padding-top: 139px; height: 900px;">
  </div>
</div>
</div>
</section>
...
<div class="row">
<div class="col-md-12">
<h4 class="trans-uppercase mb-10">Punya Pertanyaan?</h4>
