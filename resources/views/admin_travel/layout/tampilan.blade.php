...
<head>
  ...
  <link rel="stylesheet"
    href="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/css/backend-plugin.min.css')}}">
  <link rel="stylesheet"
    href="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/css/backende209.css?v=1.0.0')}}">
  <link rel="stylesheet"
    href="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/vendor/%40fortawesome/fontawesome-free/css/all.min.css')}}">
  <link rel="stylesheet"
    href="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css')}}">
  <link rel="stylesheet"
    href="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/vendor/remixicon/fonts/remixicon.css')}}">
  {{--
...
<body class="  ">
  ...
  <script src="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/js/backend-bundle.min.js')}}">
  </script>
  ...
  <!-- Chart Custom JavaScript -->
  <script async src="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/js/chart-custom.js')}}">
  </script>
