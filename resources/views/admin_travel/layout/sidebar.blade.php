<div class="iq-sidebar  sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="index.html" class="header-logo">
            <img src="{{ asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html//assets/images/logo.png')}}"
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                        ...
                                        <div class="px-3 pt-0 pb-0 sub-card">
                                                ...
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                            src="{{  asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/images/user/01.jpg') }}"
                                                            alt="01">
                                                    </div>
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                            src="{{  asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/images/user/02.jpg') }}"
                                                            alt="02">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                            src="{{  asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/images/user/03.jpg') }}"
                                                            alt="03">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{  asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/images/user/1.png') }}"
                                ...
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-0 text-center">
                                        <div class="media-body profile-detail text-center">
                                            <img src="{{  asset ('E5 (1)\E5/templates.iqonic.design/lite/posdash/html/assets/images/page-img/profile-bg.jpg') }}"
