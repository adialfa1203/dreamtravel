                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/updatetravel/{{ $data->id }}" data-toggle="validator" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        data-errors="Masukan Nama Kendaraan." required
                                            ...
                                            <div class`="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" value="uploud foto"
                                                        class="form-control image-file" name="foto" accept="image/*"
                                                        id="foto" name="foto">
                                                </div>
                                            </div>
                                            <br>
