                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="">
                            ...
                            <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <li class="submenu @yield('/travel') active">
                                    <a href="/travel">
                                ...
                                <tbody class="ligth-body">
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- <img src="{{ asset('fototravel/' . $row->foto) }}" alt="" style="width:100px;"> --}}
                                                @if ($row->foto)
                                                    <img style="max-width:100px; max-height:100px"
                                                        src="{{ asset('fototravel/' . $row->foto) }}" />
                                                @endif
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center list-action">
                                                    <a href="{{ route('dataa', $row->id) }}"
                                                        class="badge bg-primary mr-2" data-toggle="tooltip"
                                                        data-placement="top" title=""
                                                        data-original-title="Edit"><i
                                                            class="ri-pencil-line mr-0"></i></a>
                                                    <a class="badge bg-warning mr-2 border-0 delete"
                                                        data-id="{{ $row->id }}"
                                                        data-nama="{{ $row->nama_kendaraan }}" data-toggle="tooltip"
                                                        data-placement="top" data-bs-target="modal" title=""
                                                        data-original-title="Hapus" href="#"><i
    ...
    $('.delete').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "/delete_travel/" + travelid + ""
                Swal.fire(
                    'Dihapus!',
