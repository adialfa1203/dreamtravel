                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            ...
                            <a href="#" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Tambah
                                Travel</a>
                        </div>
                    </div>
                    <div class="col-lg-12">
                            ...
                            <table class="data-tables table mb-0 tbl-server-info">
                                ...
                                <tbody class="ligth-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <img src="{{ asset('fototravel/' . $row->foto) }}" alt=""
                                                style="width:100px;"> --}}
                                            @if ($row->foto)
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center list-action">
                                                ...
                                                <a class="badge bg-warning mr-2 border-0 delete"
                                                    data-id="{{ $row->id }}" data-nama="{{ $row->nama_kendaraan }}"
